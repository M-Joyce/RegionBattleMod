...
public enum LootItem{
    ...
    Cooked_Beef(Material.COOKED_BEEF,7,4),
    ...
    Oak_Log(Material.OAK_LOG,7,2),
    Leather_Chestplate(Material.LEATHER_CHESTPLATE,1,1),
    Leather_Boots(Material.LEATHER_BOOTS,1,1),
    Leather_Leggings(Material.LEATHER_LEGGINGS,1,1),
    Leather_Helmet(Material.LEATHER_HELMET,1,1),
